...
describe("widget resource URI", () => {
  it("carries the current widget version (o-2); a bump means the connector must be reconnected in Claude", () => {
    ...
    expect(WIDGET_VERSION).toBe("o-2");
    expect(WIDGET_URI).toBe("ui://vector-field-tool/widget.html?v=o-2");
  });
});
