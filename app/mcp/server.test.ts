...
describe("widget resource URI", () => {
  it("carries the current widget version (Phase O: o-1); a bump means the connector must be reconnected in Claude", () => {
    ...
    expect(WIDGET_VERSION).toBe("o-1");
    expect(WIDGET_URI).toBe("ui://vector-field-tool/widget.html?v=o-1");
  });
});
