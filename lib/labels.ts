...
export type LabelTable = {
  ...
  ui: Record<
    ...
    // Round Y: the hint for a function glued to its argument (sinx) in the second-order sentence.
    | "didYouMeanCall"
...
export const LABELS: Record<Locale, LabelTable> = {
  zh: {
    ...
    ui: {
      ...
      didYouMeanCall: "是不是想写 {call}？函数的自变量要加括号。",
      openFullPage: "在新窗口打开",
  ...
  en: {
    ...
    ui: {
      ...
      didYouMeanCall: "Did you mean {call}? A function's argument goes in parentheses.",
