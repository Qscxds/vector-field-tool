...
export const LABELS: Record<Locale, LabelTable> = {
  zh: {
    ...
    ui: {
      ...
      featuresBox: "以下结果按当前可见范围 {hv}∈[{xMin}, {xMax}]，y∈[{yMin}, {yMax}] 计算；缩放或平移后会重新计算，结论依赖于所考察的范围。",
  ...
  en: {
    ...
    ui: {
      ...
      featuresBox: "The results below are computed for the visible range {hv} ∈ [{xMin}, {xMax}], y ∈ [{yMin}, {yMax}]; they are recomputed after zooming or panning, because conclusions depend on the range examined.",
